...
class Buckets:
    ...
    @abstractmethod
    def get_bucket_buy_volume(self):
        """
        Return buy_volume_array.
        :rtype:     numpy.ndarray
        """
        raise NotImplementedError

    @abstractmethod
    def get_bucket_sell_volume(self):
        """
        Return sell_volume_array.
        :rtype:     numpy.ndarray
        """
        raise NotImplementedError
...
class BulkClassificationBuckets(Buckets):
    def __init__(self, bucket_max_volume, n_bucket):
        """
        Instantiate an object of Buckets used for volume bucketing and bulk classification
    ...
    def update(self, price, pnl_volatility_estimate, volume):
        ...
        assert self.latest_price is not None, \
            'BulkClassificationBuckets has not been initialized. ' \
